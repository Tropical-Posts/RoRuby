...
pages.home = (async () => {
    ...
    setTimeout(() => {
        getSetting('Pinned Games').then(async (result) => {
            if (result) {
                    ...
                    syncGet('pinned', async function (result) {
                        if (result && result.pinned && result.pinned.length > 0) {
                            const continueAddNode = async () => {
                                if (!added_node.parentNode) added_node = document.querySelector(".game-home-page-container div:first-child");
                                added_node.parentNode.insertBefore(pinTitle, document.querySelector('.game-home-page-carousel-title'));
                ...
                on(".game-home-page-container div:first-child", addPinned)
    ...
    setTimeout(async () => {
        ...
        `;
        (await first("#place-list .game-home-page-container")).insertBefore(favorites, (await first("#place-list .game-home-page-container .game-home-page-carousel-title:nth-child(3n)")))
